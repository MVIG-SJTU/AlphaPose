...
class Mscoco(dataset.Dataset):
    def __init__(self, train=True, sigma=1,
                 scale_factor=(0.2, 0.3), rot_factor=40):
        # root image folders
        self.img_folder = './data/coco/images'
        self.is_train = train           # training set or val set
    ...
    def __getitem__(self, index):
        ...
        imgname = reduce(lambda x, y: x + y,
                         map(lambda x: chr(int(x)), imgname))[:16]
